...
export default function ProfilePage() {
  ...
  return <div className="flex h-screen overflow-hidden bg-gray-50"><Sidebar /><div className="min-w-0 flex-1 overflow-y-auto pb-16 md:pb-0">{content}</div><aside className="hidden w-80 border-l bg-white xl:block"><Header /></aside></div>
}
